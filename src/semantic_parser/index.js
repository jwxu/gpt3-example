...
async function main() {
    ...
    const fileStream = JSON.parse(fs.readFileSync("../data/input/gpt3_thingtalk_paraphrases_fewshot.json", { encoding: 'utf8' })).data;
    ...
    var json = JSON.stringify(returnObj, null, 4);
        fs.writeFile('../data/output/fewshot_thingtalk_answer.json', json, 'utf8', function (err) {
